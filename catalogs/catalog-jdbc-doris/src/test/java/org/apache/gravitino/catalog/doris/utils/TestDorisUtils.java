...
public class TestDorisUtils {
  ...
  public void testExtractBucketNumFromSql() {
    ...
    String createTableSqlWithoutBucket = "CREATE TABLE `testTable` (\n`col1` int NOT NULL\n) ENGINE=OLAP\n DISTRIBUTED BY HASH(`col1`)";
    Distribution distributionDefault = DorisUtils.extractDistributionInfoFromSql(createTableSqlWithoutBucket);
  ...
  public void testDistributedInfoPattern() {
    ...
    String createTableSqlWithAuto = "CREATE TABLE `testTable` (\n`col1` date NOT NULL\n) ENGINE=OLAP\n PARTITION BY RANGE(`col1`)\n()\n DISTRIBUTED BY HASH(`col1`) BUCKETS AUTO";
